    ...
    <div class="content">
        ...
        <div class="bread">
            <div class="bread_fr">
                ...
                <span class="sel">자주 묻는 질문 게시판 글쓰기</span>
                <section class="page">
                	<div class="page_wrap">
                		<h2 class="page_title">자주 묻는 질문 게시판 글쓰기</h2>
                			<div class="tb_fr">
                				<form class="frm1" name="frm1" action="faqWritePro.jsp">
									<table class="tb">
									<thead>
										<tr>
										...
										<tr>
											...
											<td>
											<textarea cols=100 rows=8 name="content" id="content"></textarea></td>
										</tr>
										<tr>
											<th><label for="content2">질문 내용</label></th>
											<td>
											<textarea cols=100 rows=8 name="content" id="content"></textarea></td>
										</tr>
									<tr>
									...
									<div class="btn_group">
										...
										<a href="faqList.jsp" class="btn primary">글 목록</a>
								</div>  
								</form>  		
                			</div>
                	</div>
