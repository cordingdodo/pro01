...
<head>
   <%@ include file = header.jsp %>
    ...
    .in_btn {display: block; background-color: #333; min-width: 180px; height: 32px;
        ...
        <section class="page">
            <div class="page_wrap">
                ...
                <div class="btn_fr">
                    ...
                    <label for="ck_item1">약관에 동의</label>
                    <button type="button" id="in_btn1" class="in_btn">다음 단계로</button>
                </div>
                <script>
                var in_btn1 = document.getElementById("in_btn");
